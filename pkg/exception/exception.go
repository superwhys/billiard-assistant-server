...
var (
	...
	ErrUnauthorized          = NewBilliardException(401, " 登录过期或未登录")
	...
	ErrEnterGameRoomNeedUserName = NewBilliardException(400, "进入游戏房间失败, 缺少选手姓名")
	ErrLeaveGameRoom             = NewBilliardException(400, "离开游戏房间失败")
	ErrLeaveGameRoomNeedUserName = NewBilliardException(400, "离开游戏房间失败, 缺少选手姓名")
